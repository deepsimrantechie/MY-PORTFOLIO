...
const Intrest = () => {
  return (
    <div className="flex flex-col mt-16 px-4 lg:px-20">
      {/* Title */}
      <div className="text-center text-4xl sm:text-5xl lg:text-6xl font-bold mb-8 sm:mb-12">
        <Title text1={"MY "} text2={"PROJECTS"} />
      </div>

      {/* Container for left and right sections */}
      <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between space-y-8 lg:space-y-0 lg:space-x-10">
        {/* Left side - Image */}
        ...
        {/* Right side - Text */}
        <div className="w-full lg:w-1/2 flex flex-col space-y-4 sm:space-y-6 lg:pl-10">
